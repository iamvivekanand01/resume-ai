...
const MinimalImageTemplate = ({ data = {}, accentColor = "#059669" }) => {
    ...
    return (
        <div className="max-w-5xl mx-auto bg-white text-zinc-800 shadow-sm border border-zinc-200">
            <div className="grid grid-cols-3 gap-6">
                ...
                {/* Left Sidebar */}
                <aside className="col-span-1 bg-zinc-50 border-r border-zinc-200 p-6 pt-0">
                ...
                <main className="col-span-2 p-8 pt-0">
                    ...
                    {data.experience && data.experience.length > 0 && (
                        <section>
                            <h2 className="text-sm font-bold tracking-wider mb-4" style={{ color: accentColor }} >
                                EXPERIENCE
                            </h2>
                    ...
                    {data.project && data.project.length > 0 && (
                        <section>
                            <h2 className="text-sm uppercase tracking-wider font-bold" style={{ color: accentColor }}>
                                PROJECTS
                            </h2>
